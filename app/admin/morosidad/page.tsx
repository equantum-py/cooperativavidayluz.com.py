      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 text-center">
        ...
        <div className="text-left bg-gray-50 p-6 rounded-xl border border-gray-100 max-w-2xl mx-auto">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Clasificación automática por tramos de mora (30/60/90 días).</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Cálculo dinámico de intereses punitorios.</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Registro de gestiones y compromisos de pago.</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Asignación de cartera por analista/gestor.</li>
          </ul>
        </div>
      </div>
    </>
