      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 text-center">
        ...
        <div className="text-left bg-gray-50 p-6 rounded-xl border border-gray-100 max-w-2xl mx-auto">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Asignación de Roles (SuperAdmin, Gerencia, Caja, etc.).</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Parámetros globales (Tasas de interés, cuota de ingreso).</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Gestión de usuarios del sistema (Alta/Baja de personal).</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Plantillas de notificaciones y correos.</li>
          </ul>
        </div>
      </div>
    </>
