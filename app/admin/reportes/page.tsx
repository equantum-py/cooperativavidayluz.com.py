      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 text-center">
        ...
        <div className="text-left bg-gray-50 p-6 rounded-xl border border-gray-100 max-w-2xl mx-auto">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Exportación de balances y cuadros de resultados (PDF/Excel).</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Generación automática de Informes INCOOP.</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Gráficos de proyección de cartera crediticia.</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Métricas de captación de nuevos socios.</li>
          </ul>
        </div>
      </div>
    </>
