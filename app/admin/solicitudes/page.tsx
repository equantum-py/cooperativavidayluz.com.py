      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 text-center">
        ...
        <div className="text-left bg-gray-50 p-6 rounded-xl border border-gray-100 max-w-2xl mx-auto">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Recepción de solicitudes web.</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Verificación KYC (Documentos adjuntos).</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Motor de aprobación y rechazo transaccional.</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-emerald-500" /> Historial de comentarios de analistas.</li>
          </ul>
        </div>
      </div>
    </>
